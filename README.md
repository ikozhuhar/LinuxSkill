...
```
# Он использует файлы /var/run/utmp и /var/log/wtmp для получения подробной информации.
who
```
...
```
# Он использует /var/run/utmp и их процессы /proc.
w
```
